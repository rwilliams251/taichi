...
class KernelProfiler:
    ...
    # mode of print_info
    COUNT = (
        # print the statistical results (min,max,avg time) of Taichi kernels.
        "count")
    # print the records of launched Taichi kernels with specific profiling metrics (time, memory load/store and core utilization etc.)
    TRACE = "trace"
